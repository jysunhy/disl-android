 ...
 */
final class MethodInvocationStaticContext1 extends AbstractStaticContext {

    public MethodInvocationStaticContext1 () {
        // invoked by DiSL
    }
    ...
    /**
     * @return The return type owner and name with a call type attached to it
     */		
     public String toShortString(){
		String ownerString = __methodInsnNode ().owner;
	       ownerString = ownerString.substring(ownerString.lastIndexOf("/")+1,ownerString.length());		
	return "call(" + ownerString +"."+__methodInsnNode ().name + "())";
