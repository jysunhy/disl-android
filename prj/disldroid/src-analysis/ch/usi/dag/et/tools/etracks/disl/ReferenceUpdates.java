...
public final class ReferenceUpdates {
    ...
    public static void beforeStaticReferenceFieldStore (
        ...
        LocalElephantTracks.onStaticReferenceFieldUpdate (
            fsc.getOwnerClassName (), fsc.getName (),
    ...
    public static void beforeInstanceReferenceFieldStore (
        ...
        if (owner != null) {
            ...
            //
            LocalElephantTracks.onInstanceReferenceFieldUpdate (
                owner, fsc.getName (),
    ...
    public static void beforeReferenceArrayStore (final DynamicContext dc) {
        ...
        if (owner != null) {
            ...
            if (index < array.length) {
                ...
                LocalElephantTracks.onReferenceElementUpdate (
                    owner, index,
