			...
			final InsnList instructions = method.instructions;
				...
				for (final AbstractInsnNode instruction : instructions.toArray()) {
						...
						if (instruction instanceof MethodInsnNode) {
						 ...
						 //	System.out.println("getMethodName()=" + getMethodName()+ " & "+ "inst.name=" + inst.name + " & "+ "getSignature()=" + getSignature() + " & " +"inst.desc=" + " & " +inst.desc);


									if((getMethodName().equals(inst.name))&&(getSignature().equals(inst.desc))){
