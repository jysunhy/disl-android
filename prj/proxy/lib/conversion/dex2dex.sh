...
java -Ddisl.classes="/home/sunh/conversion/DiSLClass.class" -Xmx2g -cp $DISL_HOME/cobertura.jar:$DISL_HOME/asm-debug-all-4.0.jar:$DISL_HOME/dislserver-unspec.jar:$DISL_HOME/log4j-1.2.9.jar net.sourceforge.cobertura.instrument.Main $1"_classes.jar"
