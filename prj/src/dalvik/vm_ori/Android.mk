...
ifeq ($(WITH_JIT),true)
    ...
    LOCAL_MODULE := libdvm_assert_ori
    include $(BUILD_SHARED_LIBRARY)
    ...
    LOCAL_CFLAGS += $(target_smp_flag)
    LOCAL_MODULE := libdvm_interp_ori
    include $(BUILD_SHARED_LIBRARY)
...
ifeq ($(WITH_HOST_DALVIK),true)
    ...
    LOCAL_WHOLE_STATIC_LIBRARIES += libexpat libcutils libdex_ori liblog libz
