...
#ifdef DEBUG
	printf("Acquiring buffer -- utility (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Buffer acquired -- utility (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Queuing buffer (utility) -- send (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Buffer queued (utility) -- send (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Queuing buffer -- utility (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Buffer queued -- utility (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
}

static process_buffs * buffs_get(jlong thread_id) {
#ifdef DEBUG
	printf("Acquiring buffer -- empty (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Buffer acquired -- empty (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Queuing buffer -- empty (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Buffer queued -- empty (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
}

static void buffs_objtag(process_buffs * buffs) {
#ifdef DEBUG
	printf("Queuing buffer -- objtag (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Buffer queued -- objtag (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
}
...
#ifdef DEBUG
	printf("Acquiring buffer -- objtag (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Buffer acquired -- objtag (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Queuing buffer -- send (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Buffer queued -- send (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
}
...
#ifdef DEBUG
	printf("Acquiring buffer -- send (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Buffer acquired -- send (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
static jshort register_method(
		...
		jlong thread_id) {
#ifdef DEBUG
	printf("Registering method (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Method registered (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Marking thread (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Thread marked (%d)(thread %ld)\n", getpid(), result);
#endif
	return result;
}
...
#ifdef DEBUGANL
	printf("Analysis (buffer) start enter (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUGANL
	printf("Analysis (buffer) start exit (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
}
...
#ifdef DEBUGANL
	printf("Analysis start enter (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUGANL
	printf("Analysis start exit (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
}
...
#ifdef DEBUGANL
	printf("Analysis (buffer) end enter (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUGANL
	printf("Analysis (buffer) end exit (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
}
...
#ifdef DEBUGANL
	printf("Analysis end enter (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUGANL
	printf("Analysis end exit (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
}
...
#ifdef DEBUG
		printf("Object tagging thread start (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
		printf("Object tagging started (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
		printf("Object tagging ended (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
	}
...
#ifdef DEBUG
		printf("Object tagging thread end (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Sending thread start (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
		printf("Sending buffer (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
		printf("Buffer sent (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
	}
...
#ifdef DEBUG
	printf("Sending thread end (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
JNIEXPORT void JNICALL Java_ch_usi_dag_dislre_REDispatch_fork
(JNIEnv * jni_env, jclass this_class) {
    int childPID = fork();
...
static JNINativeMethod redispatchMethods[] = {
    ...
    {"fork",               "()V",                   (void *)&Java_ch_usi_dag_dislre_REDispatch_fork},
};
...
#ifdef DEBUG
	printf("Sending new class (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("New class sent (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
}
...
void JNICALL jvmti_callback_object_free_hook(
	...
	enter_critical_section(jvmti_env, obj_free_lock);
	{
		...
		if(obj_free_buff == NULL) {
            ...
            // pid
            pack_int(obj_free_buff->analysis_buff, getpid());
...
#ifdef DEBUG
			printf("Sending object free buffer (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
			printf("Object free buffer sent (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
		}
...
#ifdef DEBUG
	printf("Starting worker threads (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Worker threads started (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
}
...
#ifdef DEBUG
	printf("Shutting down (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
...
#ifdef DEBUG
	printf("Shut down complete (%d)(thread %ld)\n", getpid(), tld_get()->id);
#endif
}
